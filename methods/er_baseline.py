...
class ER:
    def __init__(
        ...
        self.model = select_model(self.model_name, self.dataset, self.binary, 1).to(self.device)
        self.optimizer = select_optimizer(self.opt_name, self.lr, self.model, self.binary)
